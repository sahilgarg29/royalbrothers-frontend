  ...
  return (
    <div>
      <div className="whatsapp">
        ...
        <img
          src="https://d36g7qg6pk2cm7.cloudfront.net/assets/wa_logo-78af8e2ff6153e5c6db2838470dc06142d5d53f8eb885f1ce33779de97649f0a.png"
          alt="whatsapp"
        ></img>
      ...
      <nav>
        ...
        <ul>
          ...
          <li>
            ...
            >
              <MenuItem onClick={handlePatClose}>
                <Link to="/earnwithus">Earn with us</Link>
              </MenuItem>
              <MenuItem onClick={handlePatClose}>
                {" "}
                <Link to="/partner-with-us">Own a franchise</Link>
              </MenuItem>
            </Menu>
          </li>
        </ul>
