...
const Home = () => {
  ...
  return (
    <div>
      <div className="cashback">{renderHomePage()}</div>
      ...
      <div className="subscription">
        <img
          src="https://d36g7qg6pk2cm7.cloudfront.net/assets/long_term/RBX_carousel_one-5e5beb3711f8184ba280e0791b058b8b1b4f03cad772f10b0ab39adfc5d06ec5.jpg"
      ...
      <div className="excontainer">
        ...
        <div className="exlusiveBikes">
          <div>
            ...
            <img
              src="https://d3vp2rl7047vsp.cloudfront.net/bike_models/images/000/000/255/medium/Suzuki-access-125-2019.png?1563529796"
              alt="Suzuki 125 "
            ></img>
            <hr></hr>
            <h4> ₹20/hour</h4>
        ...
        <div className="exlusiveBikes">
          <div>
            ...
            <img
              src="https://d3vp2rl7047vsp.cloudfront.net/bike_models/images/000/000/018/medium/TB_350-min_2.png?1519739776"
              alt="Thunderbird"
            ></img>
            <hr></hr>
            <h4> ₹35/hour</h4>
      ...
      <div className="heading">
        <h2 style={{ textAlign: "center", color: "#212121" }}>
